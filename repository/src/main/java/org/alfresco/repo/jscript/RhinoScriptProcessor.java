...
public class RhinoScriptProcessor extends BaseProcessor implements ScriptProcessor, ScriptResourceLoader, InitializingBean
{
    ...
    /**
     * Clean and Unset the scope from any model instance where it has been injected before
     *
     * @param model
     *            Data model containing objects to unset the scope previously defined
     * @param scope
     *            The scope to clean
     */
