...
public class ActivitiPriorityPropertyHandler extends ActivitiTaskPropertyHandler
{
    ...
    @Override protected Object handleTaskProperty(Task task, TypeDefinition type, QName key, Serializable value)
    {
        ...
        recordTaskPriorityChange(task.getId(), priority);
        return DO_NOT_ADD;
    }
    ...
    @Override protected Object handleDelegateTaskProperty(DelegateTask task, TypeDefinition type, QName key, Serializable value)
    {
        ...
        recordTaskPriorityChange(task.getId(), (Integer) value);
        return DO_NOT_ADD;
    }
    ...
    private void recordTaskPriorityChange(String id, int priority)
    {
