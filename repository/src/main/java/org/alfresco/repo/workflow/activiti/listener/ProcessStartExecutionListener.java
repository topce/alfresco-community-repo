...
import org.alfresco.repo.workflow.activiti.tasklistener.AbstractTaskListener;
 ...
 * @since 4.0
 */
public class ProcessStartExecutionListener extends AbstractTaskListener implements ExecutionListener
{
    ...
    {
        return "activitiProcessCreateListener";
    }
}
